...
interactional_cols <- c("Presa.di.turno","Richiesta.di.accordo.conferma","Manifestazione.di.accordo","Conferma.dell.attenzione","Interruzione","Cessione.del.turno","Marcatura.della.conoscenza.condivisa","Richiesta.di.attenzione","Strategie.di.cortesia")

metatextual_cols <- c("Filler..riempimento.dei.tempi.di.formulazione", "Gestione.del.topic..introduzione.o.ripresa.di.topic","Chiusura.di.un.topic","Prolettico..marca.di.formulazione..ecco","Riformulazione","Marcatura.di.citazione.discorso.riportato","Esemplificazione")

cognitive_cols <- c("Marcatura.dell.inferenza", "Modulazione.del.grado.di.confidenza.del.parlante","Approssimazione","Specificazione","Attenuazione","Intensificazione")
...
valid_micro_labels <- c("Presa.di.turno","Richiesta.di.accordo.conferma","Manifestazione.di.accordo","Conferma.dell.attenzione","Interruzione","Cessione.del.turno","Marcatura.della.conoscenza.condivisa","Richiesta.di.attenzione","Strategie.di.cortesia","Gestione.del.topic..introduzione.o.ripresa.di.topic","Chiusura.di.un.topic","Prolettico..marca.di.formulazione..ecco","Riformulazione","Marcatura.di.citazione.discorso.riportato","Esemplificazione","Marcatura.dell.inferenza","Filler..riempimento.dei.tempi.di.formulazione","Modulazione.del.grado.di.confidenza.del.parlante","Approssimazione","Specificazione","Attenuazione","Intensificazione")
...
folder_path <- "/Agreement/Task_2/dunque"
...
calculate_partial_agreement_filtered <- function(df, annotator_cols) {
  ...
  print(partial_agreement_matrix)
