...
dove i è l'occorrenza, M_i è il numero di macrofunzioni ricoperte dal SD in quell'occorrenza, e m_ij è il numero di microfunzioni di una certa macrofunzione (j) che l'SD ricopre nell'occorrenza i.
